...
/// File Contents 
/// 
///    The abstractSpread implements methods that all class that inherit from the abstractSpreadsheet require like determining dependencies
///    between cells.
///    The class allows other child classes to implement the methods that manuiplate what is stored in each cell.
/// </summary>
...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// <summary>
        /// The method determines if the start cell is dependent on a cell
        /// which is dependent on start and if so throws a CircularException.
        /// </summary>
        ...
        private void Visit(String start, String name, ISet<String> visited, LinkedList<String> changed)
        {
          ...
          {
            //only go into the if statement if one of the direct dependents of name is dependent on start
            if (n.Equals(start))
            {
            ...
            {
                        //check the dependendts of the dependents of the current cells name
