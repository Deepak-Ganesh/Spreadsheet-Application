...
/// Copyright: CS 3500 and [Keaton, Deepak] - This work may not be copied for use in Academic Coursework. 
/// 
/// I, [Deepak Ganesh; Keaton], certify that I wrote this code from scratch and did not copy it in part or whole from  
/// another source.  All references used in the completion of the assignment are cited in my README file. 
/// 
/// File Contents 
/// 
///    The class was changed so that there would be a text box inside the GUI. All changes to the textbox are done
///    in this class since it is easiar to maintain the code when the work is done in one class.
/// </summary>
...
namespace SpreadsheetGrid_Framework
{
    ...
    public partial class SpreadsheetGridWidget : UserControl
    {
        ...
        public SpreadsheetGridWidget()
        {
            ...
            //this.Input_textBox.Location = new System.Drawing.Point(drawingPanel.XPos, drawingPanel.YPos);

        }


        /// <summary>
        /// The method moves the Input_textBox to the location of where the selected cell is.
        /// </summary>
        /// <param name="contents"></param>
        public void set_InputTextboxLocation(string contents)
        {
            Input_textBox.Text = contents;
            this.drawingPanel.Update();
            this.Input_textBox.Location = new System.Drawing.Point(drawingPanel.textboxXPos, drawingPanel.textboxYPos);
        }

        /// <summary>
        /// The method is used to turn on or off the extra feature.
        /// </summary>
        /// <param name="visible"></param>
        public void setVisible(bool visible)
        {
            Input_textBox.Visible = visible;
            if (visible)
            {
                this.drawingPanel.Update();
                this.Input_textBox.Location = new System.Drawing.Point(drawingPanel.textboxXPos, drawingPanel.textboxYPos);
        ...
        /// <summary>
        /// The method returns the contents of Input_textbox if Enter was press after type into it.
        /// </summary>
        /// <returns>the contents of Input_textBox</returns>
        public string getContents()
        {
            if (Enter_Pressed)
            {
                Enter_Pressed = false;
                string output = Input_textBox.Text;
                Input_textBox.Clear();
                return output;
            }
            else
        ...
        {
            //this.Input_textBox.Location = new System.Drawing.Point(drawingPanel.YPos, drawingPanel.XPos);
        ...
        private void Input_textbox_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
