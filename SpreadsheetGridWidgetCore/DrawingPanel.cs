...
/// Copyright: CS 3500 and [Deepak] - This work may not be copied for use in Academic Coursework. 
/// 
...
/// File Contents 
/// 
///    The class was changed so that the location of the selected cell could be pulled by other classes.
/// </summary>
...
namespace SpreadsheetGrid_Framework
{
    ...
    {
        /// <summary>
        /// Only variables created to be used by the SpreadsheetGridWidget
        /// </summary>
        public int textboxXPos;
        public int textboxYPos;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if ((_selectedCol - _firstColumn >= 0) && (_selectedRow - _firstRow >= 0))
            {
                ...
                textboxXPos = SpreadsheetGridWidget.LABEL_COL_WIDTH + (_selectedCol - _firstColumn) * SpreadsheetGridWidget.DATA_COL_WIDTH + 1;
                textboxYPos = SpreadsheetGridWidget.LABEL_ROW_HEIGHT + (_selectedRow - _firstRow) * SpreadsheetGridWidget.DATA_ROW_HEIGHT + 1;
            }
